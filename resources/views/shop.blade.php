            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{ route('shop.details',$product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products/'.$product->image) }}" width="330"
                    ...
                    @if($product->images)
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('shop.details',$product->slug) }}">
                                    <img loading="lazy" src="{{ asset('uploads/products/'.$img) }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                </a>
                            </div>
                            @endforeach
                        @endif
