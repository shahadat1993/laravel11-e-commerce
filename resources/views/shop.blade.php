...
@section('content')
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0 brand-list">
                                <ul class="list list-inline mb-0 brand-list">
                                    ...
                                    @empty
                                        <span class="text-center">No Brand found</span>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            style="margin-right: 22px" aria-label="Page Size" name="pagesize" id="pagesize">
                            <option selected value="12" {{ $size == 12 ? 'selected' : '' }}> Show products per pages
                            </option>
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort Items" name="order_by" id="order_by">
    ...
    <form action="{{ route('shop') }}" method="GET" id="frmfilter">
        @csrf
    ...
    <script>
        $(function() {
            ...
            $('#order_by').on('change', function() {
                $('#order').val($('#order_by option:selected').val());
                $('#frmfilter').submit();
            })
