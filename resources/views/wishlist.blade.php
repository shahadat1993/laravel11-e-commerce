            ...
            <tbody>
              ...
              <tr>
               <td>
                ...
                <div class="col-6">
                    <form action="{{ route('wishlist.item.remove', $item->rowId) }}" method="post" id="wishlist_remove_item-{{ $item->id }}">
                    @csrf
                    @method('DELETE')
                  <a href="javascript:void(0)" class="remove-cart" onclick="document.getElementById('wishlist_remove_item-{{ $item->id }}').submit()">
