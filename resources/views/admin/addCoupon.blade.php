            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.store') }}">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="number" placeholder="Coupon Value" name="value" tabindex="0"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="number" placeholder="Cart Value" name="cart_value" tabindex="0"
