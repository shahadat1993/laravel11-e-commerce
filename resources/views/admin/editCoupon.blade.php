...
@section('content')
    @push('styles')
        ...
        <style>
            ...
            .btn-update-coupon:hover {
                transform: translateY(-4px);
                box-shadow: 0 18px 35px rgba(79, 70, 229, 0.35);
                filter: brightness(1.1);
            }
            .btn-update-coupon i { font-size: 22px; }
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center justify-between mb-10">
                <div>
                    ...
                    <div class="flex items-center gap-2 text-slate-400 font-semibold mt-1">
                        ...
                        <span class="text-indigo-600">Update #{{ $coupon->code }}</span>
                    </div>
                </div>
            ...
            <div class="wg-box">
                <form class="form-new-product" method="POST" action="{{ route('admin.coupon.update', $coupon->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" placeholder="e.g. SUMMER2026" name="code" value="{{ $coupon->code }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="number" placeholder="Enter value" name="value" value="{{ $coupon->value }}" required>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="number" placeholder="Enter min. cart value" name="cart_value" value="{{ $coupon->cart_value }}" required>
                    ...
                    <div class="mt-8 pt-6 border-t border-slate-100 flex justify-end">
                        <button class="btn-update-coupon" type="submit">
                            <i class="ri-refresh-line"></i> Update Coupon Content
                        </button>
                    </div>
                </form>
            </div>
