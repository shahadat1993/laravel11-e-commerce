    ...
    @push('styles')
        ...
        <style>
            ...
            .uploadfile {
                ...
                height: 100%;
                padding: 40px;
                display: none; /* এডিট পেজে শুরুতে হাইড থাকবে যদি ছবি থাকে */
            }

            /* প্রিভিউ এরিয়া */
            #preview-container {
                display: block; /* এডিট পেজে শুরুতে ব্লক থাকবে */
                position: relative;
                width: 100%;
                max-width: 400px;
                border-radius: 15px;
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h3 class="page-title">Edit Slide Info</h3>
                    <div class="flex items-center gap-2 text-slate-500 font-medium mt-1">
                        <span>Sliders</span> <i class="ri-arrow-right-s-line"></i> <span>Edit #{{ $slide->id }}</span>
                    </div>
                </div>
            ...
            <div class="wg-box">
                <form class="form-new-product" action="{{ route('admin.slide.update', $slide->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" placeholder="Tagline" name="tagline" value="{{ $slide->tagline }}" required>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" placeholder="Title" name="title" value="{{ $slide->title }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" placeholder="SubTitle" name="subtitle" value="{{ $slide->subtitle }}" required>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" placeholder="Link" name="link" value="{{ $slide->link }}" required>
                    ...
                    <fieldset>
                        <div class="body-title"><i class="ri-image-edit-line text-indigo-500"></i> Change Slide Image</div>

                        <div class="upload-image-wrapper" id="upload-zone">
                            <label class="uploadfile" for="myFile" id="upload-label" style="{{ $slide->image ? 'display:none;' : 'display:block;' }}">
                            ...
                            <div id="preview-container" style="{{ $slide->image ? 'display:block;' : 'display:none;' }}">
                                <img id="preview" src="{{ asset('uploads/slides/'.$slide->image) }}">
                    ...
                    <fieldset>
                        ...
                        <select name="status">
                            <option value="1" @if ($slide->status == '1') selected @endif>Active (Visible on Site)</option>
                            <option value="0" @if ($slide->status == '0') selected @endif>Inactive (Hidden)</option>
                        </select>
                        @error('status') <p class="text-danger mt-2 font-bold">{{ $message }}</p> @enderror
                    </fieldset>

                    <div class="mt-10 flex justify-end">
                        <button class="tf-button" type="submit"><i class="ri-refresh-line"></i> Update Slide Content</button>
                    </div>
                </form>
            </div>
        </div>
